...
if(!isset($_SESSION['Verified']))
{
	...
	$profile = $client->send_request($request);
...
<nav class="navbar">
        <div class="nav-links">
			...
			<?php } else {?>
                                ...
                                <a class="active" href="displayData.php" style="float:right"><?php echo $username; ?></a>
                        <?php } ?>
                </ul>
        </div>
</nav>
...
<br><br>
<h2 style="position: static; margin-left: 5px;">Settings</h2>
<nav class="profilenav">
	<hr>
	<button class ="profile">Profile</button>
        <button class ="shopPref">Shopping Preferences</button>
	<!--<a class ="profile" href="#profile">Profile</a>
	<a class ="shopPref" href="#pref">Shopping Preferences</a>-->
</nav>
<br>
<div class="userinfo">
...
$('.profile').click(function() {
	...
	$('.shopPrefForm').css('display', 'none');
});

$('.shopPref').click(function() {
